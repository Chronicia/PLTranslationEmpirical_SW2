...
# Repair compile (fix1)
bash scripts/repair.sh gpt-4o-mini avatar Java C++ 50 1.0 0.3 0 1 compile 20241225_183200 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Go 50 1.0 0.3 0 1 compile 20241225_183502 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java C 50 1.0 0.3 0 1 compile 20241225_184533 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Python 50 1.0 0.3 0 1 compile 20241225_184831 {timestamp of the fix report}
...
# Repair runtime (fix2)
bash scripts/repair.sh gpt-4o-mini avatar Java C++ 50 1.0 0.3 0 2 runtime 20241225_232928 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Go 50 1.0 0.3 0 2 runtime 20241225_233405 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java C 50 1.0 0.3 0 2 runtime 20241225_233813 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Python 50 1.0 0.3 0 2 runtime 20241225_233839 {timestamp of the fix report}
...
bash scripts/repair.sh gpt-4o-mini avatar Java C++ 50 1.0 0.3 0 3 incorrect 20241226_021007 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Go 50 1.0 0.3 0 3 incorrect 20241226_021046 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java C 50 1.0 0.3 0 3 incorrect 20241226_021241 {timestamp of the fix report}
bash scripts/repair.sh gpt-4o-mini avatar Java Python 50 1.0 0.3 0 3 incorrect 20241226_021357 {timestamp of the fix report}

...
if __name__ == "__main__":
    ...
    parser.add_argument('--mode', help='generation mode to use for code translation. should be one of [direct, context, thinking, code_thinking]', required=True, type=str)
